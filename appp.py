...
# PASO 4: EL CLIFFHANGER Y EL MAPA
    ...
    if revelar:
        ...
        st.markdown("<p class='misterio-final'>¡EL SOBRE SIGUE CERRADO! 🔐</p>", unsafe_allow_html=True)
        st.write("¡Lo descubriremos TODOS JUNTOS el día de la fiesta! No te lo puedes perder por nada del mundo.")
        
        st.divider()

        # Datos y Mapa
        st.markdown("<h1>📍 Coordenadas del Evento</h1>", unsafe_allow_html=True)
